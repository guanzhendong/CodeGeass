...
@property (nonatomic, strong) ZDQQFriendGroup *model;
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _arrowImageView.image = [UIImage imageNamed:@"cell_arrow_right_gray"];
...
- (void)setupWithModel:(ZDQQFriendGroup *)model
        ...
        didSelectBlock:(dispatch_block_t)block
{
    ...
    _numberLabel.text = [NSString stringWithFormat:@"%ld",model.friends.count];
